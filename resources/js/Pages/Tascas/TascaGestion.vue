...
<template>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <p class="text-gray-600">Listado de todas las reservas para tu tasca.</p>
        ...
        >
            ...
            <Column field="people" header="Personas" />
            ...
            <Column header="Observaciones">
                <template #body="slotProps">
                    <i
                        role="button"
                        tabindex="0"
                        :title="slotProps.data.observations ? 'Ver observaciones' : 'Sin observaciones'"
                        :class="[
        'pi',
        ...
        'focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-400 rounded cursor-pointer'
                        ...
                        aria-label="Observaciones de la reserva"
                    ></i>
                </template>
            </Column>
        </DataTable>
